...
export default function Hero() {
  return (
    <section className='grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12'>
      <div className='mr-auto place-self-center lg:col-span-7'>
        ...
        <p className='max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl'>
          From the latest gadgets to essential accessories, our products simplify your tech life. Discover why customers
          around the world trust TechStack for all their electronic needs.
        </p>
        <Link
          to='/shop'
